        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="mt-20 col-lg-4 col-md-6 col-sm-6">
                    <div class="single-team-member position-relative my-lg-3 my-md-3 my-sm-0">
                        <div class="team-image">
                            <img src="/assets/front/images/team/team-1.png" alt="Team Members"
                ...
                <div class="mt-20 col-lg-4 col-md-6 col-sm-6">
                    <div class="single-team-member position-relative my-lg-3 my-md-3 my-sm-0">
                        <div class="team-image">
                            <img src="/assets/front/images/team/team-2.png" alt="Team Members"
                                class="rounded img-fluid">
                        </div>
                        <div
                            class="text-white rounded team-info d-flex flex-column align-items-center justify-content-center">
                ...
                <div class="mt-20 col-lg-4 col-md-6 col-sm-6">
                    <div class="single-team-member position-relative my-lg-3 my-md-3 my-sm-0">
                        <div class="team-image">
                            <img src="/assets/front/images/team/team-3.png" alt="Team Members"
                                class="rounded img-fluid">
                        </div>
                        <div
                            class="text-white rounded team-info d-flex flex-column align-items-center justify-content-center">
                ...
                <div class="mt-20 col-lg-4 col-md-6 col-sm-6">
                    <div class="single-team-member position-relative my-lg-3 my-md-3 my-sm-0">
                        <div class="team-image">
                            <img src="/assets/front/images/team/team-4.png" alt="Team Members"
                                class="rounded img-fluid">
                        </div>
                        <div
                            class="text-white rounded team-info d-flex flex-column align-items-center justify-content-center">
                ...
                <div class="mt-20 col-lg-4 col-md-6 col-sm-6">
                    <div class="single-team-member position-relative my-lg-3 my-md-3 my-sm-0">
                        <div class="team-image">
                            <img src="/assets/front/images/team/team-5.png" alt="Team Members"
                                class="rounded img-fluid">
                        </div>
                        <div
                            class="text-white rounded team-info d-flex flex-column align-items-center justify-content-center">
                ...
                <div class="mt-20 col-lg-4 col-md-6 col-sm-6">
                    <div class="single-team-member position-relative my-lg-3 my-md-3 my-sm-0">
                        <div class="team-image">
                            <img src="/assets/front/images/team/team-6.png" alt="Team Members"
                                class="rounded img-fluid">
                        </div>
                        <div
                            class="text-white rounded team-info d-flex flex-column align-items-center justify-content-center">
                            ...
                            <ul class="post-meta d-flex justify-content-between align-items-center">
                                <li>
                                    <div class="post-author d-flex align-items-center">
                                        <img src="/assets/front/images/blog/author.png" class="rounded-circle"
                                            alt="image">
